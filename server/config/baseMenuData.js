module.exports = {
  allMenuItems: [
    { 
      id: 1, name: 'Vegan Bowl', category: 'Healthy Bowls', price: 350, isVeg: true, imageId: 'veganBowl',
    ...
    { 
      id: 2, name: 'Weight Gain Bowl', category: 'Healthy Bowls', price: 350, isVeg: false, imageId: 'weightGainBowl',
    ...
    { 
      id: 3, name: 'Veg Weight Gain Bowl', category: 'Healthy Bowls', price: 350, isVeg: true, imageId: 'weightGainBowl',
    ...
    { 
      id: 4, name: 'Non Veg Weight Loss Bowl', category: 'Healthy Bowls', price: 350, isVeg: false, imageId: 'weightLossBowl',
    ...
    { 
      id: 5, name: 'Weight Loss Bowl', category: 'Healthy Bowls', price: 350, isVeg: false, imageId: 'weightLossBowl',
    ...
    { 
      id: 6, name: 'Desk Friendly Tandoori Chicken Bowl', category: 'Healthy Bowls', price: 350, isVeg: false, imageId: 'chickenBowl',
    ...
    { 
      id: 7, name: 'Desk Friendly Eggs Bowl', category: 'Healthy Bowls', price: 350, isVeg: false, imageId: 'eggBowl',
    ...
    { 
      id: 8, name: 'Desk Friendly Fish Bowl', category: 'Healthy Bowls', price: 350, isVeg: false, imageId: 'fishBowl',
    ...
    { 
      id: 9, name: 'Desk Friendly Malai Chicken Bowl', category: 'Healthy Bowls', price: 350, isVeg: false, imageId: 'malaiChickenBowl',
    ...
    { 
      id: 10, name: 'Desk Friendly Grilled Paneer Bowl', category: 'Healthy Bowls', price: 350, isVeg: true, imageId: 'paneerBowl',
    ...
    { 
      id: 11, name: 'Desk Friendly Pesto Grilled Chicken Bowl', category: 'Healthy Bowls', price: 350, isVeg: false, imageId: 'pestoChickenBowl',
    ...
    { 
      id: 12, name: 'Tandoori Grilled Chicken Trial Bowl', category: 'Mini Bowls', price: 350, isVeg: false, imageId: 'chickenTrailBowl',
    ...
    { 
      id: 13, name: 'Banana, Spinach, Dry Berries Smoothie', category: 'Smoothies', price: 200, isVeg: true, imageId: 'bananaSpinachSmoothie',
    ...
    { 
      id: 14, name: 'Berries, Seeds & Apricot Smoothie', category: 'Smoothies', price: 250, isVeg: true, imageId: 'berriesApricotSmoothie',
    ...
    { 
      id: 15, name: 'Granola, Pineapple, Avocado & Flax Seeds Smoothie', category: 'Smoothies', price: 240, isVeg: true, imageId: 'granolaFlaxSmoothie',
    ...
    { 
      id: 16, name: 'Oats, Banana, Pineapple & Pumpkin Seeds Smoothie', category: 'Smoothies', price: 200, isVeg: true, imageId: 'oatsPumpkinSmoothie',
    ...
    { 
      id: 17, name: 'Seeds, Watermelon & Cucumber Smoothie', category: 'Smoothies', price: 180, isVeg: true, imageId: 'seedsWatermelonSmoothie',
    ...
    { 
      id: 18, name: 'Home Brewed Coffee Kombucha', category: 'Home brewed drinks', price: 180, isVeg: true, imageId: 'coffeeKombucha',
    ...
    { 
      id: 19, name: 'Home Brewed Himachali Tea Kombucha', category: 'Home brewed drinks', price: 180, isVeg: true, imageId: 'teaKombucha',
    ...
    { 
      id: 20, name: 'Egg Mini Bowl', category: 'Mini Bowls', price: 350, isVeg: false, imageId: 'eggTrailBowl',
    ...
    { 
      id: 21, name: 'Fish Mini Bowl', category: 'Mini Bowls', price: 350, isVeg: false, imageId: 'fishTrailBowl',
    ...
    { 
      id: 22, name: 'Malai Chicken Trail Bowl', category: 'Mini Bowls', price: 350, isVeg: false, imageId: 'malaiChickenTrailBowl',
    ...
    { 
      id: 23, name: 'Paneer Mini Bowl', category: 'Mini Bowls', price: 350, isVeg: true, imageId: 'paneerTrailBowl',
  ...
  categories: ['Healthy Bowls', 'Mini Bowls', 'Smoothies', 'Home brewed drinks']
};
